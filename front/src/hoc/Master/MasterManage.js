        ...
        <Button style = {{textAlign: 'left'}}>업무조회</Button>  
          <div style = {{display: 'flex'}}>
            <div style = {{display: 'inline-block', margin: '0px auto'}}>
                <Select name = 'year' defaultValue="년도" style={{ width: 80 }} onChange={MasterManage}>
                ...
                <Select name = 'month' defaultValue="월" style={{ width: 60 }} onChange={MasterManage}>
